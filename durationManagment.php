...
if($_GET["op"]=="edt"){    
    ...
    $sqlSearch = "SELECT * FROM Durations"
            . " WHERE Id=".$_GET["cod"];
...
<body>
    ...
    <table border="1" width="500px">
        ...
        <tr>
            <td>
                <p></p>
                <form class="vertical" id="effortForm" method="post" action="<?php echo "actions/validateDuration.php?op=".$_GET["op"]; ?>" >
                    ...
                    <input type="hidden" name="table" value="Durations">
