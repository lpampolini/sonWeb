...
<body>
    ...
    <table border="1" width="500px">
        ...
        <tr>
            <td>
                <p></p>
                <form class="vertical" id="effortForm" method="post" action="<?php echo "actions/validateSpecie.php?op=".$_GET["op"]; ?>" >
                    
                    <div class="col_3" style="margin-left: 30px">
                        <!-- Text Field -->
                        
                        <label for=“code”>Code</label>
                        <input id="name" class="general" type="text" name="Code" value="<?php echo $recordset["Code"]; ?>" />    
                    ...
                    <input type="hidden" name="table" value="Species">
