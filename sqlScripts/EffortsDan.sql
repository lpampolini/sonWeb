...
--
-- Host: localhost
-- Generation Time: Sep 18, 2014 at 12:32 AM
...
CREATE TABLE IF NOT EXISTS `EffortsDan` (
...
INSERT INTO `EffortsDan` (`ID`, `EffortNumber`, `Fisherman`, `Boat`, `EDate`, `GRID`, `LATLONG`, `R_CODE`, `SPCTRG`, `GRTP`, `GRLEN5`, `GRHTM`, `MESH5`, `GRDEP5`, `SIDEP5`, `SETYPE`, `Duration`) VALUES
