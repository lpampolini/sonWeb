...
<body>
    ...
    <table border="1" width="1500">
        ...
        <tr>
            <td>
                <p></p>
                <form class="vertical" id="effortForm" method="post" action="<?php echo "actions/validateIndividual.php?w=1&op=".$_GET["op"]; ?>" >
                    ...
                    <div class="col_4">
                        ...
                        <input id="scales" required="required" class="general" type=“text” name="Scales" value="<?php echo $recordset["Scales"]; ?>" />
                        
                        <label for="OvariesGonads">Ovaries/Gonads</label>
                        <input id="ovariesgonads" class="general" type=“text” name="OvariesGonads" value="<?php echo $recordset["OvariesGonads"]; ?>" />
                    ...
                    <?php
                        if($_GET["op"]=='add'){
                            echo '<input type="hidden" name="Harvest" value="'.$_GET["cod"].'">';
                        }
                    ?>
