...
$sqlList = " SELECT * from Durations ORDER BY Name ASC";
            ...
            <td>
                ...
                <table border="0" width="100%" height="100px">
                            ...
                            if ($numberLines[0]>0) {
                                ...
                                while ($recordset = mysql_fetch_assoc($exec)){
                                    ...
                                    echo '<tr class="tableText" href="" height="40" bgcolor="'.$bg.'" onMouseOver="this.bgColor=\'#C4CDD6\'" onMouseOut="this.bgColor=\''.$bg.'\'">';
                                        echo '<td><a href="durationManagment.php?op=edt&cod='.$recordset["Id"].'">&nbsp;'.$recordset["Name"].'</a></td>';
                                        echo '<td align="center">'
                                            . '<a href="./actions/deleteDuration.php?cod='.$recordset["Id"].'"><img src="images/delete.png" height="25px" width="25px" /></a>'
                                            . '</td>';
                                    echo '<tr/>';
                    ...
                    <tr>
                        <td>
                            <p></p>
                            <button type="button" class="normalButton" onclick="location.href='durationManagment.php?op=add'">Add new duration</button>
                        </td>
                    </tr>
...
if($_GET["msg"] === "e"){
    ...
    echo "alert('The Duration is being used for other registers. Could not be deleted.');";
    echo "</script>";
}
