...
if($_GET["op"]=="edt"){    
    ...
    $sqlSearch = "SELECT * FROM WeightForms"
            . " WHERE Id=".$_GET["cod"];
...
<body>
    ...
    <table border="1" width="500px">
        ...
        <tr>
            <td>
                <p></p>
                <form class="vertical" id="Form" method="post" action="<?php echo "actions/validateForm.php?op=".$_GET["op"]; ?>" >
                    ...
                    <input type="hidden" name="table" value="WeightForms">
