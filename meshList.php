            ...
            <td>
                ...
                <table border="0" width="100%" height="100px">
                        ...
                        <td>
                            ...
                            <table width="1914" border="1" cellpadding="0" cellspacing="0">
                                ...
                                <tr height="25" bgcolor="#D8D8D8" class="tableTitle">
                                  ...
                                  <td width="1641"><div align="left">&nbsp;Range</div></td>
                            ...
                            if ($numberLines[0]>0) {
                                ...
                                while ($recordset = mysql_fetch_assoc($exec)){
                                    ...
                                    echo '<tr class="tableText" href="" height="40" bgcolor="'.$bg.'" onMouseOver="this.bgColor=\'#C4CDD6\'" onMouseOut="this.bgColor=\''.$bg.'\'">';
                                        echo '<td><a href="meshManagment.php?op=edt&cod='.$recordset["Id"].'">&nbsp;'.$recordset["Name"].'</a></td>';
                                        echo '<td align="center">'
                                            . '<a href="./actions/deleteGrhtm.php?cod='.$recordset["Id"].'"><img src="images/delete.png" height="25px" width="25px" /></a>'
                                            . '</td>';
                                    echo '<tr/>';
                    ...
                    <tr>
                        <td>
                            <p></p>
                            <button type="button" class="normalButton" onclick="location.href='meshManagment.php?op=add'">Add new MESH</button>
                        </td>
                    </tr>
...
if($_GET["msg"] === "e"){
    ...
    echo "alert('The GRHTM is being used for other registers. Could not be deleted.');";
    echo "</script>";
}
