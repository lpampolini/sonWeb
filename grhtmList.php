            ...
            <td>
                ...
                <table border="0" width="100%" height="100px">
                            ...
                            if ($numberLines[0]>0) {
                                ...
                                while ($recordset = mysql_fetch_assoc($exec)){
                                    ...
                                    echo '<tr class="tableText" href="" height="40" bgcolor="'.$bg.'" onMouseOver="this.bgColor=\'#C4CDD6\'" onMouseOut="this.bgColor=\''.$bg.'\'">';
                                        echo '<td><a href="grhtmManagment.php?op=edt&cod='.$recordset["Id"].'">&nbsp;'.$recordset["Name"].'</a></td>';
                    ...
                    <tr>
                        <td>
                            <p></p>
                            <button type="button" class="normalButton" onclick="location.href='grhtmManagment.php?op=add'">Add new GRHTM</button>
                        </td>
                    </tr>
